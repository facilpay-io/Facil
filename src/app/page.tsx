  ...
  return (
    <>
      ...
      <main className={urbanistone.className}>
        ...
        <div className="PageWrapper hero h-[600px] lg:h-[600px] mt-3 lg:mt-3 md:mt-3 flex flex-col lg:flex-row w-full items-center justify-center">
          <div className=" lg:w-1/2 text-left text-white xl:text-5xl lg:text-4xl md:text-4xl lg:pt-0 pt-10 pr-2 pl-2 lg:pt-0 md:pt-0  text-2xl font-semibold">
            <p className="pl-4 pb-2 lg:pl-12 lg:pb-6 md:pb-6">A Revolutionary Messaging</p>
            <p className="pl-4 pb-2 lg:pl-12 lg:pb-6 md:pb-6">and Payment Platform</p>


            <p className="text-base lg:text-xl pl-4 lg:pl-12 font-normal">Powered by blockchain technology and integrated AI</p>
          ...
          <div className="mt-4 lg:mt-16 lg:w-1/2 w-full flex justify-center items-center overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row componentWrapper pt-0 lg;pt-16">
          ...
          <div className="textFade lg:w-1/2 w-full lg:pl-20 pl-0">
            <h2 className="text-3xl lg:text-4xl font-semibold pb-4 lg:pt-24 pt-8">Message-centric Payment Platform Governed by User-Intent Web3 Technology</h2>
        ...
        <section className="max-w-[780px] m-auto pt-32 mb-30">
          <div className="text-center"><h1 className="text-3xl lg:text-4xl font-semibold mb-0">Got questions?</h1>
            <p className="mb-14">Get the answers to your questions about FacilPay.</p></div>
        ...
        <section className="flex justify-center items-center pt-40 relative">
          <div className="AppContainer w-[1408px] lg:h-[980px] h-[480px] overflow-hidden text-center text-white font-inter flex flex-col justify-between relative">
            <div>
              <h1 className="text-2xl lg:text-6xl font-semibold lg:pt-40 pt-16">Get the FacilPay mobile app now</h1>
              <p className="text-base p-2">Use everything FacilPay offers from one simple app</p>
            </div>
