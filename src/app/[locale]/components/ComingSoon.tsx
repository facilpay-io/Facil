            ...
            <div className={className}>
                <div className="flex flex-col items-center text-center gap-10">
                    <div className="flex flex-col items-center text-center gap-3">
                        ...
                        <h3 className="text-6xl xl:text-8xl 2xl:text-9xl font-semibold uppercase tracking-normal xl:tracking-wider bg-[linear-gradient(357.82deg,_#B8B8B8_1.46%,_#FFFFFF_80.78%)] bg-clip-text text-transparent">Coming<br />Soon</h3>
                    </div>
        ...
        <div className="bg-[#080808] h-screen" >
            <div className="relative h-full">
                ...
                <div className="flex flex-col md:gap-12 h-full ">
                    <Info className="lg:hidden pt-24 md:pt-12 z-[1]" />
                    <div className="relative h-full w-ful flex flex-col justify-end">

                        <div className="relative mx-auto w-full max-w-screen-sm md:max-w-screen-sm lg:max-w-screen-md 2xl:max-w-screen-lg">
                            ...
                            <Image src="/coming_soon/xrp.png" width={500} height={600} alt="phone_banner" className="hidden lg:block absolute w-[170.6891px] h-[200.3442px] top-[16px] left-[12px]  md:-left-[64px] object-cover blur-[3px] opacity-[70%] animate-float-delayed" />

                            <Image src="/coming_soon/usdc.png" width={500} height={600} alt="phone_banner" className="hidden lg:block absolute w-[170.6891px] h-[200.3442px] top-[35%] lg:-right-[100px] xl:-right-[180px] object-cover opacity-[70%] animate-float-delayed" />
                            ...
                            <div className="relative px-[32px] md:px-0 inset-0 w-full h-full">
                                ...
                                <Image src="/coming_soon/iPhone.png" width={500} height={600} alt="phone_banner" className="block w-full h-full object-cover mix-blend-luminosity" />

                                <div className="absolute bottom-0 pt-[12px] md:pt-[24px] lg:pt-[28px] 2xl:pt-[38px] left-[48px] right-[48px] md:left-[29px] md:right-[30px] lg:left-[32px] lg:right-[32px] 2xl:left-[47px] 2xl:right-[48px] h-full">
                                    <div className="hidden lg:block h-full rounded-t-[48px] md:rounded-t-[80px] lg:rounded-t-[110px] 2xl:rounded-t-[136px] 3xl:rounded-t-[180px] bg-[linear-gradient(180deg,_#080A0D_-5.85%,_#182E50_30.58%,_#080808_60.46%)] ">
                                        <div className="pt-[20px] h-full xl:pt-[40px] 2xl:pt-[80px]">
                                            <Info className="w-full" />
                                        </div>
                                    </div>
                                    <div className="lg:hidden relative h-full w-full">
                                        <Image src="/coming_soon/app_screenshot.png" alt="app_screenshot" width={300} height={600} className="w-full h-full object-cover object-[0%_0%] rounded-t-[48px]" />
                            ...
                            <Image src="/coming_soon/eth.png" width={500} height={600} alt="phone_banner" className="absolute w-[80px] h-[80px] md:w-[120px] md:h-[150px] xl:w-[170.6891px] xl:h-[200.3442px] bottom-[30%] md:top-[55%] left-[12px] md:-left-[40px] xl:-left-[150px] object-cover opacity-[70%] animate-float" />
