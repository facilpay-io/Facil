      ...
      <main className={urbanistone.className}>
        ...
        <div className="flex flex-col lg:flex-row componentWrapper pt-0 lg:pt-16">
          ...
          <div className="p-0 textFadeRight lg:w-1/2 w-full">
            <h2 className="text-2xl lg:text-4xl font-semibold pb-0 lg:pt-20 pt-4 "> Paying and Getting Paid is as Easy as Chatting</h2>
            <p className="text-base pt-4"><span className="HomeTitle">Crypto and Fiat Transactions Simplified; </span>
